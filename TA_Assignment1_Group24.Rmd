...
Some recommendations that can be drawn from this analysis are that although the overall sentiment behind the reviews is slightly more positive than negative, Disneyland HongKong should make significant improvements to their park. Research indicates that people want to be nice and acknowledge effort, which could explain why the average sentiment is still higher. This indicates that people say at least one positive thing in this review. 
